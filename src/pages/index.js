  ...
  return (
    ...
    >
      ...
      <main className='max-w-screen-sm mx-auto relative'>
        <div className={`min-h-[105vh] ${ hour >= 18 ? 'bg-slate-900 text-slate-300' : 'bg-gradient-to-tr from-sky-400 to-violet-600'}`}>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="absolute top-10 w-2/3">
                  ...
                  <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm bg-opacity-70 border-gray-300 rounded-lg bg-gray-50 " placeholder="Search here.." value={query} onChange={handleInputChange} name="query"></input>
            ...
            <div className='absolute top-[20vh] overflow-hidden'>
              ...
              { weatherData && weatherData.data ? (
                <div>
                  <h1 className='font-medium'>{`${weatherData.city_name}, ${weatherData.data[0].weather.description}`}</h1>
